...
const Home = () => {
    ...
    return (
        <div>
            ...
            {/* Why Choose LOXTR? - RESTORED TO ORIGINAL DESIGN */}
                ...
                <div className="container mx-auto px-6 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
                            {CONFIG.features[lang].slice(0, 4).map((feature, i) => (
                                <motion.div
                                    key={i}
            ...
            {/* Radar AI Promotion - Positioned before Sectors */}
            <RadarPromotionBanner lang={lang} />

            {/* Sectors We Cover - 3 Column Grid */}
            <section className="py-24 bg-navy relative overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {CONFIG.industries.slice(0, 3).map((item, i) => (
                            <motion.div
                                key={i}
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                ...
                                className="group relative h-96 rounded-2xl overflow-hidden cursor-pointer shadow-xl border border-white/5"
                            >
                                <div
