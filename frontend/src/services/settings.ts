...
const DEFAULT_SETTINGS: SiteSettings = {
    ...
    office_address_en: "Sogutozu, Nergiz Str. No:7, F:13/N:25, 06560 Yenimahalle, Ankara, Turkey",
    office_address_tr: "Sogutozu, Nergiz Sok. No:7, K:13/D:25, 06560 Yenimahalle, Ankara, Turkiye",
